export type SiteView = "home" | "start" | "checkin" | "projects" | "ai" | "community" | "faq" | "profile";

export const SITE_VIEW_COOKIE_KEY = "douge_current_site_view";

const siteViews: SiteView[] = ["home", "start", "checkin", "projects", "ai", "community", "faq", "profile"];
