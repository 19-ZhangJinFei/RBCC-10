<div align="center">
  ...
  <p>
    <a href="https://douyun-huazhang-3g29.vercel.app/">
      <img src="https://img.shields.io/badge/上游历史演示-douyun--huazhang--3g29.vercel.app-8b5cf6?style=for-the-badge" alt="豆韵上游历史演示入口" />
    </a>
  </p>
</div>
...
RBCC 挑战营于 **2026 年 7 月 12 日**开营，本项目团队于 **2026 年 7 月 16 日**开始本次项目开发。当前仓库使用开源项目 [Hunter0809/DouYun](https://github.com/Hunter0809/DouYun) 作为技术底座，并在此基础上开展面向 RBCC 场景的问题定义、产品重构、功能迭代和验证；不将上游既有代码表述为本次活动期间从零编写。

为保证研发过程可核验，仓库保留上游原始提交历史、作者信息和许可证，并使用 `upstream-history` 分支与 `upstream-douyun-4cc8306` 标签标记引入时的技术基线。**2026 年 7 月 18 日**完成仓库接入、代码审查和透明基线记录，此后每项 RBCC 迭代均通过真实日期的 commit 和 pull request 留痕，不倒签日期、不改写作者。详细信息见 [来源与版权说明](ATTRIBUTION.md) 和 [RBCC 研发日志](docs/RBCC_DEVELOPMENT_LOG.md)。

页面顶部的 Vercel 链接是上游项目保留下来的历史演示环境，仅用于了解既有技术底座，不代表本 RBCC 仓库的独立部署成果。
...
本项目沿用仓库 [LICENSE](LICENSE) 中的 **GNU Affero General Public License v3.0（AGPL-3.0）**。使用、修改和分发代码时须遵守许可证条款，并保留原始版权与许可证声明。上游来源、基线提交和本次 RBCC 开发边界见 [ATTRIBUTION.md](ATTRIBUTION.md)。开源许可只覆盖代码本身，用户上传图片、AI 生成内容和社区发布作品仍应遵守各自素材来源、平台规则和相关法律要求。
